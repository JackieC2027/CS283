...
From this class, I want to be able to apply some of my learnings from my last co-op  
and take new information about low-level networking using an industry-standard language like C.

5. Briefly describe any concerns you might be having with being successful in this class (if any).

Some of my concerns with my success in class would be my proficiency in Clang, as well as my  
habit of overthinking. When I was working, I was mainly coding in Golang, so I will need some time  
to get used to the syntax again. In addition, I tend to spend a lot of time on assignments because  
I feel that I might miss little things, which causes me to overthink about the coursework. Given  
some time, I think I will get back into the hang of things.